  ...
  return (
    <Grid container spacing={2} mt="1px">
      ...
      <HookTextField
        {...registerState('topic')}
        rules={{ required: { value: true, message: 'This field is required' } }}
        textFieldProps={{ ...commonInputStyles, label: 'Topic', placeholder: 'What insight are you looking for?', required: true }}
        gridProps={{ xs: 12 }}
      />
      <HookTextField
        {...registerState('email')}
        ...
        textFieldProps={{ ...commonInputStyles, label: 'Email', placeholder: "So we can notify you when it's ready", required: true }}
        gridProps={{ xs: 12 }}
      />

      <Grid item xs={12} sx={{ mt: -0.5, mb: -1.5 }}>
