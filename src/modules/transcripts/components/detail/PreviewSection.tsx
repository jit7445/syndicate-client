...
export default function PreviewSection({ preview, onBuyClick }: PreviewSectionProps) {
  return (
    <div className="rounded-lg border border-gray-200 bg-main-background p-6">
      ...
      <div className="relative mt-4">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-gradient-to-t from-main-background via-main-background/90 to-transparent">
          ...
          <p className="text-sm font-medium text-text-primary">Buy the transcript to read the rest</p>
          <Button variant="contained" label="Buy Transcript" onClick={onBuyClick} />
        </div>
      </div>
    </div>
  )
