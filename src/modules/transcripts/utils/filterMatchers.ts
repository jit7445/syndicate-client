...
export const matchesPrice = (price: number, filter: PriceFilterValue): boolean => {
  switch (filter) {
    case "free":
      return price === 0
    case "under-100":
...
export const matchesPublishedDate = (dateString: string, filter: PublishedDateFilterValue): boolean => {
