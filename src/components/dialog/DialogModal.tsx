      ...
      >
        ...
        >
          <Grid container sx={{ display: 'flex', alignItems: 'center', flexWrap: 'nowrap' }}>
            ...
            <Grid item sx={{ flexShrink: 0, pl: 1, display: 'flex', justifyContent: 'flex-end', paddingTop: '5px' }}>
              <CloseIcon onClick={handleClose} className="cursor-pointer" />
            </Grid>
          </Grid>
        </DialogTitle>
        <DialogContent sx={{ backgroundColor: '#fafafa', padding: '0.75rem 1rem', ...contentSx }}>
          {children}
        </DialogContent>
      </Dialog>
