...
import type { FieldValues, FormState, UseControllerProps, UseFormSetValue, UseFormTrigger } from 'react-hook-form'
...
const Component = <T extends FieldValues>({
  ...
  const { onChange, onBlur, notifyText, name: _, inputProps, ...rest } = textFieldProps
